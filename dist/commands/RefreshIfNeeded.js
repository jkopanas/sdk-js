    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, (0, node_fetch_1.default)(new node_fetch_1.Request({
                        ...
                        .then((0, ErrorHandling_1.handleErrors)("refresh token"))
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    credentials = _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, (0, ImpersonateCredentials_1.default)(config)];
                case 3:
                    credentials = _a.sent();
                    _a.label = 4;
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                ...
                request.headers.set("Authorization", "Bearer ".concat(credentials.accessToken));
